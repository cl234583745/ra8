...
#define BSP_CFG_ESCCLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL2Q) /* ESCCLK Src: PLL2Q */
#define BSP_CFG_ESCCLK_DIV (BSP_CLOCKS_ESC_CLOCK_DIV_8) /* ESCCLK Div /8 */
#define BSP_CFG_DSMIFCLK_SOURCE (BSP_CLOCKS_CLOCK_DISABLED) /* DSMIFCLK Disabled */
