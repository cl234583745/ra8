...
*/
ee_u8 stack_memblock[TOTAL_DATA_SIZE * MULTITHREAD] __attribute__((section(".bss.dtcm")));// __attribute__((section(".dtcm_noinit"))); __attribute__((section(".bss.dtcm")))
#if MAIN_HAS_NOARGC
MAIN_RETURN_TYPE
coremain(void) 
{
...
coremain(int argc, char *argv[])
{
    ...
    results[0].iterations = (ee_u32)get_seed_32(4);
#if CORE_DEBUG
    results[0].iterations = 1;
#endif
    results[0].execs = (ee_u32)get_seed_32(5);
