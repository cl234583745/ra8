...
typedef enum e_elc_event_ra8d1
{
    ...
    ELC_EVENT_MIPIDSI_SEQ0                  = (0x1D3), // Sequence operation channel 0 interrupt
    ELC_EVENT_MIPIDSI_SEQ1                  = (0x1D4), // Sequence operation channel 1 interrupt
    ELC_EVENT_MIPIDSI_VIN1                  = (0x1D5), // Video-Input operation channel1 interrupt
    ELC_EVENT_MIPIDSI_RCV                   = (0x1D6), // DSI packet receive interrupt
    ELC_EVENT_MIPIDSI_FERR                  = (0x1D7), // DSI fatal error interrupt
    ELC_EVENT_MIPIDSI_PPI                   = (0x1D8), // DSI D-PHY PPI interrupt
