...
static const uint32_t g_sample_prv_dip_sws[] =
{
	(uint32_t) BSP_IO_PORT_00_PIN_09,  // SW1
	(uint32_t) BSP_IO_PORT_00_PIN_08,  // SW2
};
/** Array of LED IOPORT pins. */
static const uint32_t g_sample_prv_leds[] =
{
    (uint32_t) BSP_IO_PORT_07_PIN_14,   ///< LED1
    (uint32_t) BSP_IO_PORT_03_PIN_03,   ///< LED2
    (uint32_t) BSP_IO_PORT_10_PIN_07,   ///< LED3
};
#endif
/***********************************************************************************************************************
