...
/* Object 0x1008 */
   ...
   /*ECATCHANGE_START(V5.13) COE6*/
    /* Object 0x10F0 */
   {NULL,NULL,  0x10F0, {DEFTYPE_RECORD, 2 | (OBJCODE_REC << 8)}, asEntryDesc0x10F0, aName0x10F0, &sBackupparameterhandling, NULL, NULL, NonVolatileWordOffset_0x10F0 },
   /*ECATCHANGE_END(V5.13) COE6*/
    /* Object 0x10F1 */
...
UINT16 COE_ObjDictionaryInit(void)
{
    ...
    if(CDPObjDic != NULL)
	{
		result = AddObjectsToObjDictionary((TOBJECT OBJMEM *) CDPObjDic);
	}
    ...
    if(FoEApplicationObjDic != NULL)
    {
        result = AddObjectsToObjDictionary((TOBJECT OBJMEM *) FoEApplicationObjDic);
    }
